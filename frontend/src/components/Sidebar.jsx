  ...
  return (
    <aside className="w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        <Link
          to="/notifications"
          className={`btn btn-ghost justify-start w-full gap-3 px-3 normal-case flex items-center justify-between ${currentPath === "/notifications" ? "btn-active" : ""
            }`}
        >
      ...
      <div className="p-4 border-t border-base-300 mt-auto hover:bg-base-300 transition-colors cursor-pointer">
